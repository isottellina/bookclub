...
POSTGRES_USER = os.getenv("POSTGRES_USER", "debug")
POSTGRES_PASSWORD = os.getenv("POSTGRES_PASSWORD", "debug")
POSTGRES_DB = os.getenv("POSTGRES_DB", "bookclub")
